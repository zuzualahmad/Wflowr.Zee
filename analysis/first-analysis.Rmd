...
For names not to overlapp i removed the names of Ligands and Targets from the X-axis and Y-axis and kept it ike this (if you press on any dot you'll see the name of ligand, target and if approved or not!) That way I can do more than just 25 rows (5000 rows presented here)
